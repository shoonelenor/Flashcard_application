...
import com.example.stardeckapplication.databinding.ActivityManagerReportsBinding
...
class ManagerReportsActivity : AppCompatActivity() {
    ...
    private lateinit var b: ActivityManagerReportsBinding
    ...
    // Filters
    private var reportStatusFilter: String = DbContract.REPORT_OPEN // open | resolved | all
    private var deckStatusFilter: String = "all" // active | hidden | all
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b = ActivityManagerReportsBinding.inflate(layoutInflater)
    ...
    private fun applyFilters() {
        ...
        // Better empty message (HCI: clear feedback)
        if (empty) {
            if (all.isEmpty()) {
    ...
    private fun showDbFixDialog(e: Exception) {
        MaterialAlertDialogBuilder(this)
            ...
            .setMessage(
                "The database schema changed after new features.\n\n" +
