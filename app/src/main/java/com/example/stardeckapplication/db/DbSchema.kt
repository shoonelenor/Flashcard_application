...
object DbSchema {
    ...
    private fun createCategoriesTable(db: SQLiteDatabase) {
        ...
        db.execSQL(
            ...
            ON ${DbContract.TCATEGORIES}(${DbContract.CATISACTIVE}, ${DbContract.CATSORTORDER})
            """.trimIndent()
        )
    }
    ...
    private fun createSubjectsTable(db: SQLiteDatabase) {
        db.execSQL(
            ...
            CREATE TABLE IF NOT EXISTS ${DbContract.TSUBJECTS} (
                ...
                FOREIGN KEY(${DbContract.SUBJCATEGORYID})
                    REFERENCES ${DbContract.TCATEGORIES}(${DbContract.CATID})
                    ON DELETE CASCADE
            )
            """.trimIndent()
        )
        db.execSQL(
            ...
            ON ${DbContract.TSUBJECTS}(
                ${DbContract.SUBJCATEGORYID},
                ${DbContract.SUBJISACTIVE},
                ${DbContract.SUBJSORTORDER}
            )
            """.trimIndent()
        )
    }
    ...
    private fun createLanguagesTable(db: SQLiteDatabase) {
        ...
        db.execSQL(
            ...
            ON ${DbContract.TLANGUAGES}(${DbContract.LANGISACTIVE}, ${DbContract.LANGSORTORDER})
            """.trimIndent()
        )
    }
    ...
    private fun createSubscriptionPlansTable(db: SQLiteDatabase) {
        ...
        db.execSQL(
            ...
            ON ${DbContract.TSUBSCRIPTIONPLANS}(${DbContract.SPISACTIVE}, ${DbContract.SPSORTORDER})
            """.trimIndent()
        )
    }
    ...
    private fun createAchievementsTable(db: SQLiteDatabase) {
        ...
        db.execSQL(
            ...
            ON ${DbContract.TACHIEVEMENTS}(${DbContract.AISACTIVE}, ${DbContract.ASORTORDER})
            """.trimIndent()
        )
    }
    ...
    private fun createUserSubscriptionsTable(db: SQLiteDatabase) {
        ...
        db.execSQL(
            ...
            ON ${DbContract.TUSERSUBSCRIPTIONS}(${DbContract.USUSERID}, ${DbContract.USISACTIVE})
            """.trimIndent()
        )
    }
}